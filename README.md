...
The Android ads run on the native `com.ezoic.sdk:ezoic-ads-sdk:1.6.0` library, which is
...
```gradle
dependencies {
    implementation 'com.ezoic.sdk:ezoic-ads-sdk:1.6.0'
}
```
...
`pod 'EzoicAdsSDK', '~> 1.6.0'` to the generated Xcode project's `Podfile` and runs
