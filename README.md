...
```
https://github.com/ezoic/ezoic-unity-sdk.git#v1.9.1
```
...
{
  "dependencies": {
    "com.ezoic.ads": "https://github.com/ezoic/ezoic-unity-sdk.git#v1.9.1"
  }
}
```

The `#v1.9.1` suffix pins a released version; omit it to track the default branch.

### 2. Provide the native Android library

The Android ads run on the native `com.ezoic.sdk:ezoic-ads-sdk:1.9.1` library, which is
...
```gradle
dependencies {
    implementation 'com.ezoic.sdk:ezoic-ads-sdk:1.9.1'
}
```
...
`pod 'EzoicAdsSDK', '~> 1.9.1'` to the generated Xcode project's `Podfile` and runs
